...
//   return (
//     <div>InterviewHome</div>
//   )
// }


import React, { useState, useRef } from "react";
import "../style/InterviewHome.scss";
...
const InterviewHome = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      setFileName(file.name); // Store the name in state
    }
  };
        ...
        <div className="interview-card__body">
          ...
          <div className="panel panel--right">
            ...
            <div className="upload-section">
              ...
              <label className="dropzone" htmlFor="resume">
                {/* Conditional Rendering: Show checkmark if file exists, else show upload icon */}
                <span className="dropzone__icon">
                  {fileName ? (
                    // A simple "Success" checkmark icon
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="28"
                      height="28"
                ...
                <p className="dropzone__title">
                  {/* If file exists, show name, otherwise show default text */}
                  {fileName ? (
